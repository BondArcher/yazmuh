                    ...
                    <li>
                        ...
                        <div class="container">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="active"><a data-toggle="tab" href="#kisi">Kişi</a></li>
                                <li><a data-toggle="tab" href="#birim">Birim</a></li>
                                <li><a data-toggle="tab" href="#kalem">Kalem</a></li>
                                <li><a data-toggle="tab" href="#tarih">Tarih</a></li>
                            </ul>

                            <div class="tab-content">
                                <div id="kisi" class="tab-pane fade in active">
                                    <h3>           Kisi        </h3>
                                </div>
                                <div id="birim" class="tab-pane fade">
                                    <h3>          Birim        </h3>
                                </div>
                                <div id="kalem" class="tab-pane fade">
                                    <h3>          Kalem        </h3>
                                </div>
                                <div id="tarih" class="tab-pane fade">
                                    <h3>          Tarih        </h3>
                                </div>
                            </div>
                        </div>
