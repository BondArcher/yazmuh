...
<head>
    ...
    if(isset($_POST['comp']) && isset($_POST['budget']) && isset($_POST['treshold']) ){
        $comp=$_POST['comp'];
        $budget=$_POST['budget'];
        $treshold=$_POST['treshold'];
        $query = $db->prepare('UPDATE components SET budget = ? , treshold = ? WHERE id= ?');
        $query->execute(array($budget,$treshold,$comp));
    }
    ?>

    <!-- start: Meta -->
    <meta charset="utf-8">
    <title>Ust Limit Belirle</title>
    <!-- end: Meta -->
    ...
    <div class="row-fluid">
        ...
        <div id="content" class="span10">
            ...
            echo "<div class=\"panel panel-primary\">
                <div class=\"panel-heading\">Ust Limit Belirleme Paneli</div>
                    ...
                    foreach($db->query('SELECT id,component_type FROM components') as $row) {
                        ...
                        echo"</select>";
                        echo"<h3>Ust Limit:</h3></br>";
                        echo"<input type='text' name='budget' required size='20'/>";
                        echo"<h3>Asma Esigi:</h3></br>";
                        echo"<input type='text' name='treshold' required size='20'/></br>";
                        echo "<input type=\"submit\" value=\"Belirle\" />";
                        echo"</form>";
